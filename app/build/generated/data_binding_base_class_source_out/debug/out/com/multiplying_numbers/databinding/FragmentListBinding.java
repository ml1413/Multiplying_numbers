...
public final class FragmentListBinding implements ViewBinding {
  ...
  private FragmentListBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView buttonBack,
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentListBinding((ConstraintLayout) rootView, buttonBack, recyclerView);
    }
