 ...
 */
public abstract class Hilt_FragmentList extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentList(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentList_GeneratedInjector) this.generatedComponent()).injectFragmentList(UnsafeCasts.<FragmentList>unsafeCast(this));
    }
  }
