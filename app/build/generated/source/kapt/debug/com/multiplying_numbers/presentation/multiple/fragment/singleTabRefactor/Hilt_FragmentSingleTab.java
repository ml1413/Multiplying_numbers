 ...
 */
public abstract class Hilt_FragmentSingleTab extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentSingleTab() {
    super();
  }

  Hilt_FragmentSingleTab(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentSingleTab_GeneratedInjector) this.generatedComponent()).injectFragmentSingleTab(UnsafeCasts.<FragmentSingleTab>unsafeCast(this));
    }
  }
