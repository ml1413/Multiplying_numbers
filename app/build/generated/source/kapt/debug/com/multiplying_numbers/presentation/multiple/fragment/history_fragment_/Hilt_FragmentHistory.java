 ...
 */
public abstract class Hilt_FragmentHistory extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentHistory() {
    super();
  }

  Hilt_FragmentHistory(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHistory_GeneratedInjector) this.generatedComponent()).injectFragmentHistory(UnsafeCasts.<FragmentHistory>unsafeCast(this));
    }
  }
