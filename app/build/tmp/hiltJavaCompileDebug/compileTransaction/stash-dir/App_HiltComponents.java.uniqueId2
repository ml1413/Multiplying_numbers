...
public final class App_HiltComponents {
  ...
  @Component(
      modules = {
          ...
          com.multiplying_numbers.presentation.di.Module.class
      }
  )
  @Singleton
  ...
  @Subcomponent(
      modules = {
          ...
          ListTablesViewModel_HiltModules.KeyModule.class,
          SingleTabViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          ListTablesViewModel_HiltModules.BindsModule.class,
          SingleTabViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
